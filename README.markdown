...
4. [Setup - The basics of getting started with bussmtp](#setup)
    * [What bussmtp affects](#what-bussmtp-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with bussmtp](#beginning-with-bussmtp)
